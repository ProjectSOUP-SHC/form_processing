...
generate_delivery_roster <- function(input, output, session, dels) {
  ...
  generated_sheet <- gs4_find(paste("Orders_", Sys.Date(), sep = ''))
  print(generated_sheet)
  return("https://docs.google.com/spreadsheets/d/1Q6E54v3SScR8c8_26ppbcc7sTijFFL7k4QjJotaJhCM/edit#gid=1704659122")
}
# 
